...
LambdaUP.onmousemove = function () {
  document.getElementById("labelLambda1").innerText =
    "Верхняя граница диапазона длин волн (нм):";
  updateChart();
};

LambdaDOWN.onmousemove = function () {
  document.getElementById("labelLambda2").innerText =
    "Нижняя граница диапазона длин волн (нм):";
  updateChart();
};
